...
> **Hocine BALEH**, **Lina CHRAÂ** sous encadrement de **Dr. Nouamane ARHACHOUI**
...
Ce dataset est initialement issu de :
> Zhu, L., He, Y., & Zhou, D. (2020). *Neural opinion dynamics model for the prediction of user-level stance dynamics.* Information Processing & Management, 57(2), 102031.
 
Et enrichi par :
> Minici, M., Cinus, F., Monti, C., Bonchi, F., & Manco, G. (2022). *Cascade-based echo chamber detection.* CIKM 2022.
